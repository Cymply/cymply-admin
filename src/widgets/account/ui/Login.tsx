    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
        ...
        <button
          onClick={() => {/* 구글 로그인 핸들러 */}}
          disabled={loading}
          className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg mb-6 flex items-center justify-center gap-2 transition-colors disabled:opacity-50 border border-gray-300"
        >
          <svg
            width="20"
            height="20"
